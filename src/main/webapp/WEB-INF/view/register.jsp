				...
				<div class="card">
					...
					<div class="card-body">
						<form action="createUser" method="post">
							...
							<div class="mb-3">
								<label>Enter DOB</label> <input type="text" name="dob"
									class="form-control" required>
							</div>

							<div class="mb-3">
								<label>Enter Gender</label> <input type="text" name="gender"
									class="form-control" required>
							</div>
							...
							<div>
								<p class="text-center mt-3">Alredy have an account?<a href="login">Login</a></p>
							</div>
						</form>
					</div>
				</div>
